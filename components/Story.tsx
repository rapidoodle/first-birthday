  ...
  return (
    <Section id="story" className="py-16 md:py-24">
      <Reveal className="mx-auto max-w-2xl">
        <div className="relative rounded-[2.5rem] border border-white/70 bg-white/60 p-10 text-center shadow-fairy backdrop-blur-xl md:p-14">
          <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-5xl" aria-hidden>
            🎀
          </span>
          <p className="font-script text-2xl text-fairy-rose md:text-3xl">
            our fairytale story
          </p>
          <p className="mt-6 text-lg leading-relaxed text-fairy-ink/85 md:text-xl">
